...
def run_demo(dataset, target):
    ...
    # Save results
    # scores
    with open('output/scores.pkl', 'wb') as f:
        pkl.dump(sorted_scores, f)
    # Features
    with open('output/selected_features.pkl', 'wb') as f:
        pkl.dump((features, selected_features), f)
...
if __name__ == "__main__":
    ...
    # Data obtained from https://www.kaggle.com/ronitf/heart-disease-uci
